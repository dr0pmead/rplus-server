...
// Type: RPlus.SDK.Infrastructure.Integration.IApiKeyStore
...
{
  Task<ApiKeyMetadata?> GetBySecretAsync(
    string secret,
    string env,
    CancellationToken cancellationToken);

  Task RevokeAsync(Guid keyId, CancellationToken cancellationToken);
}
