...
// Type: RPlus.Gateway.Application.Contracts.Responses.HomeDashboardResponse
...
public record HomeDashboardResponse(UserProfileDto UserProfile, LoyaltyInfoDto Loyalty);
