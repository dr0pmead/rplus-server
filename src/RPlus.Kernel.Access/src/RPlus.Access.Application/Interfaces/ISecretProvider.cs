...
// Type: RPlus.Access.Application.Interfaces.ISecretProvider
...
{
  Task<string?> GetSecretAsync(string key, CancellationToken cancellationToken = default (CancellationToken));
}
