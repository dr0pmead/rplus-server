...
// Type: RPlus.Users.Infrastructure.UsersDbContextFactory
...
public class UsersDbContextFactory : IDesignTimeDbContextFactory<UsersDbContext>
{
  public UsersDbContext CreateDbContext(string[] args)
  {
    ...
    optionsBuilder.UseNpgsql<UsersDbContext>(args.Length != 0 ? args[0] : "Host=localhost;Database=rplus_users;Username=postgres;Password=postgres", (Action<NpgsqlDbContextOptionsBuilder>) (npgsql => npgsql.MigrationsHistoryTable("__EFMigrationsHistory", "users")));
