...
// Type: RPlus.Kernel.Integration.Application.Features.Partners.Queries.ListPartnersResult
...
public record ListPartnersResult(List<IntegrationPartner> Items, int TotalCount);
