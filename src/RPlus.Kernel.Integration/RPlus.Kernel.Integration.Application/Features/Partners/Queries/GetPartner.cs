...
// Type: RPlus.Kernel.Integration.Application.Features.Partners.Queries.GetPartnerQuery
...
public record GetPartnerQuery(Guid Id) : IRequest<IntegrationPartner?>, IBaseRequest;
