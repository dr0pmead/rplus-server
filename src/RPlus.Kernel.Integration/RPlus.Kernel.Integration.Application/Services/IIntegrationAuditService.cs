...
// Type: RPlus.Kernel.Integration.Application.Services.IIntegrationAuditService
...
{
  Task LogAsync(IntegrationAuditLog log, CancellationToken cancellationToken = default (CancellationToken));
}
